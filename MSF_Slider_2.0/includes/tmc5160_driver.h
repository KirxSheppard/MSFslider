...
{
public:
    SetupTmc5160(uint16_t cs) : driver(cs, R_SENSE, SW_MOSI, SW_MISO, SW_SCK) {}
    void setup(uint8_t toff, uint8_t blank_time, uint16_t rms_current, uint16_t microsteps, bool en_pwm_mode);
